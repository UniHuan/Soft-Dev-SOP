...
├─ [1.0h] 高保真原型设计 & 设计系统       ├─ [3.5h] App Store 素材准备
├─ [2.0h] 架构搭建 & 目录结构            ├─ [4.5h] 内购/订阅配置
├─ [2.5h] 数据层 (Model + Service)       ├─ [5.5h] Archive & TestFlight
├─ [4.5h] 业务逻辑层 (ViewModel)         ├─ [6.5h] App Store Connect 提交
├─ [6.0h] UI 层 (View) ← 按原型实现      └─ [8.0h] 提交审核 & 文档归档
└─ [7.5h] 自测 & 代码 Review
```
...
## Phase 1.5: 高保真原型设计 & 设计系统 (1:00 - 2:00)
